...
Se almacenan identidad y rol de administradores; hash salado y versión de la contraseña complementaria cuando se configura; configuración de la aplicación; código, datos sociodemográficos y ocupacionales, Forma, filtros, consentimiento, respuestas y resultados V3. El flujo digital también conserva resultado demostrativo, fecha y hash de IP. Ni los hashes de contraseña ni el hash de IP aparecen en la interfaz o exportaciones.
